...
public class AppointmentsAdapter extends RecyclerView.Adapter<AppointmentsAdapter.AppointmentsViewHolder> {
    ...
    //When clicking the cancel button, notifies the client fragment that an appointment was deleted and the deletion action is performed there
    ...
    public void onBindViewHolder(@NonNull AppointmentsViewHolder holder, int position) {
        //Display the date, time, service type, and hair dresser name for the appointment
        ...
        //Call for cancellation and deletion of the appointment when clicking the CANCEL button
