...
public class AdminAppointmentsAdapter extends RecyclerView.Adapter<AdminAppointmentsAdapter.AppointmentViewHolder> {
    ...
    public void onBindViewHolder(@NonNull AppointmentViewHolder holder, int position) {
        ...
        // Display date, time and service type - information is taken directly from the fragment based on customer selection
        ...
        holder.cancelButton.setOnClickListener(v -> {
            // Delete the appointment from Firebase - convert to appropriate format to reach the correct path
        ...
        if (clientId != null && !clientId.isEmpty()) {
            ...
            //If details not found, display UNKNOWN for the relevant part of the appointment
