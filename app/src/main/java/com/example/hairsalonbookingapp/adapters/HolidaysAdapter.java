...
public class HolidaysAdapter extends RecyclerView.Adapter<HolidaysAdapter.HolidayViewHolder> {
    ...
    public void onBindViewHolder(@NonNull HolidayViewHolder holder, int position) {
        ...
        // Set different background color based on holiday type
                ...
                if (holiday.isGeneral()) {
                    ...
                    generalHolidaysRef.child(holiday.getDate()).removeValue()
                            .addOnSuccessListener(aVoid -> {
                                // Remove from all hairdressers' personal holidays
    ...
    // Remove a general holiday from all hairdressers' personal holiday lists
